        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SolutionSteps = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    HardwareOrSoftware = table.Column<string>(type: "nvarchar(max)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_SupportRequests_KnowledgeBases_KnowledgeBaseId",
                        column: x => x.KnowledgeBaseId,
                        principalTable: "KnowledgeBases",
                        principalColumn: "KnowledgeBaseId",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Quotes_SupportRequests_SupportRequestId",
                        column: x => x.SupportRequestId,
                        principalTable: "SupportRequests",
                        principalColumn: "SupportRequestId",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_RepairJobs_SupportRequests_SupportRequestId",
                        column: x => x.SupportRequestId,
                        principalTable: "SupportRequests",
                        principalColumn: "SupportRequestId",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_RepairJobSpareParts", x => new { x.RepairJobId, x.SparePartId });
                    table.ForeignKey(
                        name: "FK_RepairJobSpareParts_RepairJobs_RepairJobId",
                        column: x => x.RepairJobId,
                        principalTable: "RepairJobs",
                        principalColumn: "RepairJobId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_RepairJobSpareParts_SpareParts_SparePartId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Quotes_SupportRequestId",
                table: "Quotes",
                column: "SupportRequestId",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_RepairJobs_SupportRequestId",
                table: "RepairJobs",
                column: "SupportRequestId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RepairJobSpareParts_SparePartId",
                table: "RepairJobSpareParts",
                column: "SparePartId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SupportRequests_KnowledgeBaseId",
                table: "SupportRequests",
